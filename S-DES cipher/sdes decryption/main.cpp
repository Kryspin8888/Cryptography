...
cout<<endl<<endl<<endl;
cout<<"*ODSZYFROWYWANIE: "<<endl<<endl<<endl;
...
szyfr11[0]=szyfr2[4];  szyfr11[1]=szyfr2[5];  szyfr11[2]=szyfr2[6];  szyfr11[3]=szyfr2[7];
szyfr11[4]=szyfr2[0];  szyfr11[5]=szyfr2[1];  szyfr11[6]=szyfr2[2];  szyfr11[7]=szyfr2[3];
...
szyfr22[0]=szyfr1[3];  szyfr22[1]=szyfr1[0];  szyfr22[2]=szyfr1[2];  szyfr22[3]=szyfr1[4];
szyfr22[4]=szyfr1[6];  szyfr22[5]=szyfr1[1];  szyfr22[6]=szyfr1[7];  szyfr22[7]=szyfr1[5];

cout<<endl<<endl;
cout<<"Tekst po permutacji odwrotnej - ODSZYFROWANY TEKST: "<<endl;
for(int j=0; j<8; j++)
    cout<<szyfr22[j]<<" ";
